...
def any_craps(dado_01, dado_02):
    ...
    if soma == 2 or soma == 3 or soma  == 12:
        ...
        resultado = "A soma dos dados deu 4, 5, 6, 7, 8, 9, 10 ou 11, portanto você perdeu a rodada!"
    return resultado 
...
#se a resposta o jogdador quiser joga iniciar uma nova rodada    
        ...
        if fichas == 0:
            ...
            if escolha == "FIELD":
                ...
                elif rodada == "A soma dos dados deu 4, 5, 6, 7, 8, 9, 10 ou 11, portanto você perdeu a rodada!":
                    fichas -= aposta
                    print (rodada)
                    print ('')
                    time.sleep(1)
